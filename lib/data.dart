import 'package:planetinfoapp/home_screen.dart';
...
class PlanetInfo {
  PlanetInfo({
    ...
    this.summerTemperature,
    this.winterTemperature,
  });
  ...
  final String? surfaceGravity;
  final String? surfaceTemperature;
  final String? summerTemperature;
  final String? winterTemperature;
}
...
List<PlanetInfo> planets = [
  PlanetInfo(
    ...
    diameter: 4880,
    distanceFromSun: '67.198 M Km',
    rotationPeriod: '59 Days',
    surfaceGravity: '3.7 M/s^2',
    surfaceTemperature: '167 C',
    summerTemperature: '473 C',
    winterTemperature: '-183 C',
  ),
  PlanetInfo(
    position: 2,
    name: 'Venus',
    iconImage: 'images/venus1.png',
    description:
  ...
  PlanetInfo(
      ...
      images: [],
      diameter: 6792,
      distanceFromSun: '228 M Km',
      rotationPeriod: '1.03 Day',
      surfaceGravity: '9.8 M/s^2',
      surfaceTemperature: '-63 C',
      summerTemperature: '17 C',
      winterTemperature: '-140 C'),
  PlanetInfo(
    position: 5,
    name: 'Jupiter',
    iconImage: 'images/jupiter1.png',
    description:
    ...
    images: [],
    diameter: 142984,
    distanceFromSun: '779 M Km',
    rotationPeriod: '9H 55 Mins ',
    surfaceGravity: '25 M/s^2',
    surfaceTemperature: '-120 C',
    summerTemperature: 'UNKNOWN',
    winterTemperature: 'UNKNOWN',
  ),
  PlanetInfo(
    position: 6,
    name: 'Saturn',
    iconImage: 'images/saturn1.png',
    description:
    ...
    images: [],
    diameter: 120536,
    distanceFromSun: '9.57 AU',
    rotationPeriod: '10H 39 Mins ',
    surfaceGravity: '10.4 M/s^2',
  ...
  PlanetInfo(
    ...
    rotationPeriod: '17H 14 Mins',
    surfaceGravity: '8.7 M/s^2',
    surfaceTemperature: '-210 C',
    summerTemperature: 'UNKNOWN',
    winterTemperature: 'UNKNOWN',
  ),
  PlanetInfo(
